...
- Beyond Holistic Scores: Trait-Based Automated Scoring of Argumentative Essays
- Essay Evaluation Based on Rubrics for Personality Traits, Supported by Cross-Questioning
- Multi-Agent Argumentation and Integrated Grammar Critique
- Agreement Between Large Language Models and Human Raters in Essay Scoring: A Research Synthesis
- LCES: Example-Free Automated Essay Scoring via Pairwise Comparisons (EMNLP 2025)
- EnemIA: correção de redações do Enem com LLMs
